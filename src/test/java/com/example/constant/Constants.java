...
public class Constants {
    public static final List<String> HERBIVORE_FOODS = List.of("Трава", "Различные растения");
    public static final List<String> PREDATOR_FOODS = List.of("Животные", "Птицы", "Рыба");
